...
export default function Home() {
  return (
    <ChatProvider>
      <div className="h-screen bg-gray-50 dark:bg-black/20">
        <div className="max-w-[720px] mx-auto p-4 h-full">
          <div className="flex flex-col h-full border border-black/20 dark:border-white/10 shadow bg-white dark:bg-black/40">
